...
PlasmoidItem {
    ...
    function pushConfig() {
        ...
        const cfg = {
            ...
            virtualSinkDescription: Plasmoid.configuration.virtualSinkDescription,
            virtualSourceDescription: Plasmoid.configuration.virtualSourceDescription,
            setAsDefaultSource: Plasmoid.configuration.setAsDefaultSource,
